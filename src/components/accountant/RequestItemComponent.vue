    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-success btn-lg" @click="getBankAccount(request.id)"
      ...
      axios.get('http://localhost:8400/manager/card/' + data["id"], {
        headers: {
          ...
          .catch(error => {
            ...
            this.error = error.response.data.message; // Заменяем текущий массив сообщений новым сообщением
            this.success = ''; // Очищаем успешное сообщение
          });
    },
    created() {
